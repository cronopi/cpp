...
/*   Updated: 2025/05/21 13:02:15 by roberto          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void BitcoinExchange::checkFile(char *argv)
{
 	...
 	for (size_t i = 0; i < date.size(); i++)
	{
		...
		std::cout << "year : " << fields["year"] << std::endl;
		std::cout << "month : " << fields["month"] << std::endl;
		std::cout << "day : " << fields["day"] << std::endl;
