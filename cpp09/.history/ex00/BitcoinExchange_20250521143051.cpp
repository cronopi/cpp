...
/*   Updated: 2025/05/21 14:30:51 by roberto          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 	...
 	for (size_t i = 0; i < date.size(); i++)
	{
		...
		else
		{
			...
			else
			{
				...
				else if (fields["year"] == 2022 && (fields["month"] > 3 || (fields["month"] == 3 && fields["day"] > 29)))
				{
					std::cerr << "Error:  bad input => no data available after 2022-03-29" << std::endl;
				}
				else
				{
					if (exchange[i] < 0)
