...
/*   Updated: 2025/08/12 13:42:02 by roberto          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*     Span example = Span(4);
    ...
    std::cout << sp.shortestSpan() << " es el numero con menor diferencia\n" << std::endl
    std::cout << sp.longestSpan() << " es el numero con mayor diferencia\n" << std::endl;
